...
public class MainPageObject {
 ...
 /*   public WebElement waitForElementPresent123(String locator, String error_message, long timeoutInSeconds)
    ...
    public void isTextOfSearchAvailable() //lesson2 homework1
    {
...
// так как мы ищем элемент с текстом, а он часто короткий, то пока сделал множитель 2 (иначе длина свайпа маленькая)
    ...
    public String waitForElementAndGetAttributes(String locator, String attribute, String error_message, long timeoutinseconds)
    {
        WebElement element = waitForElementPresent(locator, error_message, timeoutinseconds);
    ...
    private By getLocatorByString(String locator_with_type)
    {
        ...
        if (by_type.equals("xpath")) {
            ...
            throw new AssertionError("Cannot get type of locator. Locator: " + locator_with_type);
